...
export class ProductosZigmaSinFireBaseService {
  ...
  productosSinBase: Producto[] = [
...

    {
      ...
      NombreProducto: ' Araña Publicitaria inflable',
      color: 'A definir por el cliente',
    ...
    },
    {
      ...
      NombreProducto: 'Castillo palmeras',
    ...
    },
    {
      ...
      NombreProducto: 'Castillo Cocodrillo',
      color: 'A escoger ',
    ...
    },
    {
      ...
      NombreProducto: 'dummis publicitarios ',
      color: 'A definir por el cliente',
    ...
    },
    {
      ...
      NombreProducto: 'Tobogan cocodrillo',
      color: 'A definir por el cliente',
...

    {
      ...
      NombreProducto: 'Botellas Publicitarias Inflables',
      color: 'A definir por el cliente',
